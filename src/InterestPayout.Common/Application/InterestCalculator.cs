...
namespace InterestPayout.Common.Application
{
    public static class InterestCalculator
    {
        ...
        /// <param name="interestRate">Positive or negative interest rate, where <c>decimal.One</c> represents +100%</param>
        ...
        /// <item><description>Input interest rate is lower than minus 100% (less than <c>decimal.MinusOne</c>), which would mean subtracting more than current total balance;</description></item>
        ...
        public static double CalculateInterest(decimal balance, decimal interestRate, int accuracy)
        {
            ...
            if (interestRate < decimal.MinusOne)
            ...
            var decimalAmount = decimal.Multiply(balance, interestRate);
            var roundedDecimalAmount = decimal.Round(decimalAmount, accuracy, MidpointRounding.ToZero);
